...
public class MemoryResponse {
    ...
    public MemoryResponse(double total_gb, double used_gb, double free_gb, double used_percent, String checked_at) {
    ...
    public void setTotal_gb(double total_gb) {
        this.total_gb = total_gb;
    }
    ...
    public void setFree_gb(double free_gb) {
        this.free_gb = free_gb;
    }
    ...
    public boolean isAlert_triggered() {
        return alert_triggered;
    }

    public void setAlert_triggered(boolean alert_triggered) {
